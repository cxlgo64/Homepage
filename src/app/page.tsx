  ...
  return (
    ...
    <div className="slider_container box-border m-0 p-0  ">
      <div className="leftSlide ">
        <div className=' bg-[#7b110b] text-[#fad4a2]'><h2 className='text-3xl p-5'>Galley</h2></div> 
        <div className=' bg-[#8d1f19] text-[#fad4a2]'><h2 className='text-3xl p-5'>Project Experience</h2></div>
        <div className=' bg-[#943833] text-[#fad4a2]'><h2 className='text-3xl p-5'>Technology Stack</h2></div>
        <div className=' bg-[#8c4d4a] text-[#fad4a2] '><h2 className='text-3xl text-left pt-5 pb-5 m-5'>Here is Jonathan(Xueliang) Chen</h2>
      ...
      <div className='rightSlide'>
        ...
        <div className='right-2  box-border h-full'>
          <div className='inLeft float-left gap-y-72 grid-rows-4 grid-flow-col text-2xl'>
